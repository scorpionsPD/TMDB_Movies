...
class SideMenubar: UIView {
    ...
    //Data Store
    var arrBtnImageList = [SideMenuImageList]()
    ...
    //MARK: - Create Design
    func createUI(view: UIView,arrBtnImageList: [SideMenuImageList]) -> UIView {
        ...
        viewTransperant.backgroundColor = UIColor(red:21.0/255.0, green:24.0/255.0, blue:23.0/255.0, alpha:0.8)
    ...
    //MARK: - Tapped Event
    @objc func tappedOnButtons(sender: UIControl) {
